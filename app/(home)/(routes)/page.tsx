...
export default async function Home() {
	return (
		<main className="w-full min-h-without_navbar flex flex-col gap-y-4 ">
			<section
				id="mainBrand"
				className="w-full  lg:px-16 h-[308px] md:h-[380px] lg:h-[408px] flex flex-col"
			>
				<div className="w-full h-full relative bg-slate-50">
					{/*  */}
					<BrandAnimation />

					<div className="md:w-[300px] lg:w-[350px] xl:w-[380px] border-none md:flex bg-white md:absolute md:top-14 lg:top-14 xl:top-16 md:left-8 lg:left-12 xl:left-20 transition">
